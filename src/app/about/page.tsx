    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-2xl mx-auto px-4 sm:px-6 py-12 w-full">
        ...
        <article className="prose-chinese text-base sm:text-[1.0625rem]">
          <p>笔名城东，又名洛城东。喜爱文学的理科生。1987年毕业于中国科学技术大学近代物理系，同年通过李政道教授的CUSPEA项目赴美留学。德州大学奥斯汀分校物理博士，加州大学伯克利分校金融博士。2009年迁居宾州里海谷，从事独立投资和写作至今。</p>
          ...
          <p>《我有所爱，且为所爱》是他的长篇处女作，历时多年完成。小说跨越三十八年，写一群从大陆出发的留学生在美国的精神史——从无根到有根，从寂寞到沉静，从"我属于哪里"到"我如何在任何地方栖居"。</p>
