    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="prose-chinese text-base sm:text-lg text-gray-700 dark:text-gray-300 leading-loose mb-12">
          <p>变迁篇，是洛城东的生命地图，也是几代中国人在时代洪流中寻找自身位置的缩影。</p>

          <p>《雨山前》与《告别童年》，是这张地图的起点。雨山是童年的地标，溪边的少年尚不知道，他将走得多远，离得多久。告别童年不只是年岁的增长，也是一种世界观的更迭——从无忧到有重，从单纯到复杂。这两篇放在篇首，像是变迁的序曲。</p>

          <p>《以女儿的名义》，是父亲视角的深情之作，透过女儿的成长映照出岁月的流动。《四月天，人间有美赛珍珠》，借赛珍珠（Pearl Buck）在中国的人生，写文化跨越与扎根的可能——一个美国女子在中国活出了中国心，而洛城东则在美国活成了自己的模样。</p>

          <p>《千屈菜》，写的是一种湿地植物，在北美随处可见，却是入侵物种，四面受敌，仍年年盛放。这是变迁篇里最有深意的比喻之一——漂流者的处境，有时就是这样，在不属于自己的土地上，顽强而孤独地生长。《无依之地忍冬花》，同样以植物为镜，写在漂泊中仍能绽放的生命力。</p>

          <p>《磨难中的天才——苏东坡》，是这一篇章的重心。苏东坡一生跌宕，屡遭贬谪，却以超然之心活出旷达之境。洛城东写苏东坡，也是在写自己所信仰的人生态度：磨难不能消除，但可以转化。《孤山独秀》，亦是此意的延伸——在险峻之地，仍能独自挺立。</p>

          <p>最后，两篇《棠梨》尤为动人。《棠梨——遥远的记忆》写童年故乡的那株棠梨，《棠梨牵出12800公里连线》则写它如何牵出一条跨越大洋的情感线索。相距一万两千八百公里，写的似乎是乡愁，读出来的是安居。变迁，终究带来的不是失去，而是以另一种方式的拥有。</p>
        </div>
