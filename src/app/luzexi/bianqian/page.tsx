...
const articles = [
  ...
  '时闻折竹声', '无依之地忍冬花', '磨难中的天才——苏东坡的闲散、低迷和旷达',
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="prose-chinese text-base sm:text-lg text-gray-700 dark:text-gray-300 leading-loose mb-12">
          ...
          <p>《以女儿的名义》，是父亲视角的深情之作，透过女儿的成长映照出岁月的流动。《人间有美赛珍珠》，写赛珍珠（Pearl Buck）的一生，写文化跨越与桥梁——一个美国女子在中国活出了中国心，而洛城东则在美国活成了自己的模样。</p>
          ...
          <p>《磨难中的天才——苏东坡的闲散、低迷和旷达》，是这一篇章的重心。苏东坡一生跌宕，屡遭贬谪，却以超然之心活出旷达之境。洛城东写苏东坡，也是在写自己所信仰的人生态度：磨难不能消除，但可以转化。《孤山独秀》，亦是此意的延伸——在险峻之地，那种傲然挺立的精神。</p>
